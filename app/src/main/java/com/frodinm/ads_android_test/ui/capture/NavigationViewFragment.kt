...
import com.frodinm.ads_android_test.databinding.NavigationViewFragBinding
...
class NavigationViewFragment: BaseFragment() {
    ...
    private lateinit var binding: NavigationViewFragBinding
    ...
    override fun onCreateView(
        ...
        binding = NavigationViewFragBinding.inflate(inflater,container,false)
