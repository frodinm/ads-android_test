...
class TimeCaptureFragment: BaseFragment() {

    private val viewModel: TimeCaptureViewModel by viewModel()
    private lateinit var binding: TimeCaptureFragBinding
    ...
    override fun onCreateView(
        ...
        binding = TimeCaptureFragBinding.inflate(inflater,container,false)
